...
export const HELP = `review-export

Build a code review handoff bundle for ChatGPT 5.4 Pro.

Usage:
  bun run review-export -- [options]

Options:
  --compare <spec>         auto | uncommitted | staged | base:<branch> | commit:<sha> | range:<revset>
                           default: auto
  --output <path>          Save markdown bundle to this path.
                           default: .review-export/<timestamp>-review-bundle.md
  --help                   Show this help.

Examples:
  bun run review-export -- --compare auto
  bun run review-export -- --compare base:main
  bun run review-export -- --compare staged --output review.md
